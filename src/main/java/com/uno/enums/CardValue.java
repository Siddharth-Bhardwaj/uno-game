...
public enum CardValue {
    ZERO("0", null), ONE("1", null), TWO("2", null), THREE("3", null),
    FOUR("4", null), FIVE("5", null), SIX("6", null), SEVEN("7", null),
    EIGHT("8", null), NINE("9", null),

    DRAW_2("D2", CardAction.DRAW_2.name()), REVERSE("REVERSE", CardAction.REVERSE.name()),
    SKIP("SKIP", CardAction.SKIP.name()),

    WILD("WILD", CardAction.WILD.name()), WILD_DRAW_4("WILD_D4", CardAction.WILD_D4.name());

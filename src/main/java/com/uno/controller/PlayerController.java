...
public class PlayerController {
    ...
    @PutMapping("/joinGame")
    ResponseEntity<Game> joinGame(@RequestParam String playerName,
    ...
    ResponseEntity<Game> leaveGame(@RequestParam String playerId,
                                   @RequestParam String gameId) throws IllegalArgumentException {
